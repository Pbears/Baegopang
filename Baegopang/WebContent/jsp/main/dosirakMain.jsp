	...
	<a href="#">
	    <div class="thumbnail">
	      ...
	      <div class="caption">
	        ...
	        <p>
	        	<%
					for (int j=0; j < dosirakDao.selectDosirak(8).get(i).getGpa() ; j++){
				%>
					<span class="glyphicon glyphicon-star" aria-hidden="true"></span>
				<%
						if(j == dosirakDao.selectDosirak(8).get(i).getGpa() && j <5){
							for(int k=0; k < 5-dosirakDao.selectDosirak(8).get(i).getGpa(); k++){
				%>
				...
				%>
	        	<br>
	        	<%=dosirakDao.selectDosirak(8).get(i).getLocation()%><br>
