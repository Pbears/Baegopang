	...
	<a href="#">
	    <div class="thumbnail">
	      ...
	      <div class="caption">
	        ...
	        <p>
	        	<%
					for (int j=0; j < japanFoodDao.selectJapanFood(7).get(i).getGpa() ; j++){
				%>
					<span class="glyphicon glyphicon-star" aria-hidden="true"></span>
				<%
						if(j == japanFoodDao.selectJapanFood(7).get(i).getGpa() && j <5){
							for(int k=0; k < 5-japanFoodDao.selectJapanFood(7).get(i).getGpa(); k++){
				%>
				...
				%>
	        	<br>
	        	<%=japanFoodDao.selectJapanFood(7).get(i).getLocation()%><br>
